...
#file_name1 = 'test_0507.bsq_rf_cp0'
import pandas as pd
import numpy as np
...
def hyper(path_hdr,path_bsq):
    ...
    wavelength_wave = np.array(pd.DataFrame(pd.read_excel("C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\HyperSpectralAnalysis_VegationIndex\\band_name.xlsx")).columns.str.replace('nm', '').astype('float64'))

##################################################NDVI####################################################################

    RSR_red_fileName = 'C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\HyperSpectralAnalysis_VegationIndex\\ReflectanceSpectralResponse_I1_red_SNPP_VIIRS.csv'
    ...
    RSR_IR_fileName = 'C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\HyperSpectralAnalysis_VegationIndex\\ReflectanceSpectralResponse_I2_IR_SNPP_VIIRS.csv'
    ...
    band_name = pd.DataFrame(pd.read_excel("C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\HyperSpectralAnalysis_VegationIndex\\band_name_NDVI.xlsx")).columns
    df_test = pd.DataFrame(wave_all_first_deriv_concat,columns=band_name)
    X = df_test.iloc[:,:].values
################################################Call_Models###############################################################
    with open('C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\RF_20210713.pickle', 'rb') as file0:
...
############################################################################################################
    ...
    plt.colorbar()
    #plt.grid()
    plt.savefig('C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\static\\images\\healthy_without_dust_I.png')
    ...
    plt.colorbar()
    plt.savefig('C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\static\\images\\healthy_without_dust_II.png')
...
#################################show_NDVI#####################################################################
    ...
    plt.colorbar()
    plt.savefig('C:\\Users\\user\\Desktop\\Demo1(windows)\\welcome\\static\\images\\NDVI.png')
